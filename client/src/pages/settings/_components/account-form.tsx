...
import { useUpdateUserMutation, useDeleteUserMutation } from "@/features/user/userAPI";
...
export function AccountForm() {
  ...
  const onSubmit = (values: AccountFormValues) => {
    ...
    updateUserMutation(formData)
      ...
      .catch((error) => {
        toast.error(error.data.message || "Gagal memperbarui akun");
      });
  };
  ...
  const handleDeleteAccount = () => {
    deleteUserMutation()
      ...
      .catch((error) => {
        toast.error(error.data.message || "Gagal menghapus akun");
      });
  };
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex flex-col gap-2">
              ...
              <p className="text-xs text-muted-foreground">
                Rekomendasi: Square JPG, PNG, setidaknya 300x300px.
              </p>
            </div>
          </div>
        </div>
          ...
          <AlertDialog>
            ...
            <AlertDialogContent>
              <AlertDialogHeader>
                ...
                <AlertDialogDescription>
                  Tindakan ini tidak bisa dibatalkan. Ini akan menghapus akun Anda secara permanen beserta semua data transaksi dari server kami.
                </AlertDialogDescription>
              </AlertDialogHeader>
              <AlertDialogFooter>
