...
const ColumnMappingStep =({
  ...
  return (
    ...
    <DialogHeader>
      <DialogTitle>Peta Kolom CSV</DialogTitle>
      <DialogDescription>
        Cocokkan kolom dari file Anda dengan kolom data transaksi
      </DialogDescription>
    </DialogHeader>
        ...
        <Table>
          <TableHeader>
            <TableRow>
              ...
              <TableHead>Kolom Transaksi</TableHead>
            </TableRow>
          </TableHeader>
          <TableBody>
    ...
    <div className="flex justify-between">
        ...
        >
          Lanjut ({validMappingsCount}/{transactionFields.length})
