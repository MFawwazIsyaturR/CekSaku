            ...
            <div className="mx-auto w-full max-w-md">
              ...
              <div className="p-4 space-y-6">
                <div className="space-y-2">
                  {/* Determine settings link based on current path */}
                  {(() => {
                    const isAdminZone = location.pathname.startsWith("/admin");
                    const settingsHref = isAdminZone ? "/admin/settings" : "/settings";
                    ...
                    return (
                      <Button
                        ...
                        className={cn(
                          ...
                          location.pathname.startsWith(settingsHref) && "border-primary bg-primary/5"
                        )}
                        onClick={() => {
